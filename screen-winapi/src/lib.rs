...
fn attr_w(fg: Fg, bg: Bg) -> WORD {
    let fg = match fg {
        ...
        Fg::BrightRed => FOREGROUND_INTENSITY | FOREGROUND_RED,
        Fg::Green => FOREGROUND_GREEN,
        Fg::BrightGreen => FOREGROUND_INTENSITY | FOREGROUND_GREEN,
        ...
        Fg::BrightBlue => FOREGROUND_INTENSITY | FOREGROUND_BLUE,
        Fg::Magenta => FOREGROUND_RED | FOREGROUND_BLUE,
        Fg::BrightMagenta => FOREGROUND_INTENSITY | FOREGROUND_RED | FOREGROUND_BLUE,
        Fg::Cyan => FOREGROUND_BLUE | FOREGROUND_GREEN,
        Fg::BrightCyan => FOREGROUND_INTENSITY | FOREGROUND_BLUE | FOREGROUND_GREEN,
